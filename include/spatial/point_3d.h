...
namespace cityscape {
namespace spatial {
class Point_3d : public cityscape::spatial::Point<3> {
 public:
  Point_3d() = default;

  Point_3d(cityscape::id_t id, const std::string& name,
...
BOOST_GEOMETRY_REGISTER_POINT_3D_GET_SET(cityscape::spatial::Point_3d, double,
